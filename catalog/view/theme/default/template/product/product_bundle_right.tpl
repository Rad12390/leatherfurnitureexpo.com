...
<?php
/*
  #file: catalog/view/theme/default/template/product/product_bundle_right.tpl
...
<div id="content" class="bundle_right"><?php echo $content_top; ?>
  ...
  <div class="strating_at_value" itemprop="offers" itemscope itemtype="http://schema.org/Offer"><span itemprop="price"><?php echo  str_replace(".00","",$product_grouped[0]['starting_price']);  ?></div>
 </span> </div>
  <div class="header_info1">

  <div class="heading">
  <h2 itemprop="name"><?php echo $heading_title; ?></h2></div>
  ...
  <?php  // echo "<pre>"; print_r($product_grouped); ?>
      <div class= "sku">
  <?php echo "SKU:"; ?>
 <span itemprop="sku"><?php echo $product_grouped[0]['grouped_sku'] ; ?></span>
  </div>
    ...
    <div class="left">
      ...
      <div class="image">
        ...
        <div class="gp-imgr-default" style="border:0;">
          ...
          <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorboxs"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" itemprop="image"  /></a>
        ...
        <div class="image-additional">
          ...
          <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="colorboxs"><img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
          <?php } ?>
        </div>
        <?php } ?>
        <?php  if ($options) { ?>
          ...
          <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
            ...
            <div class="option-image">
              ...
              <span id = "colorImage-<?php echo $i; ?>" style="float=left;">
                <a onclick="return false;" onmouseover="imageName('<?php echo $option_value['name']; ?>');"><img onmouseover="Tip('\&lt;img src=<?php echo $option_value['image']; ?> width=150 /\&gt;')" onmouseout="UnTip()" src="<?php echo $option_value['image']; ?>" width ="50px"; alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" /></a>
              </span>
              <?php $i++; } ?>
            </div>
          </div>
...
<a onclick="PopupCenter('/index.php?route=product/product_grouped/swatch/product_id=<?php echo $product_id; ?>', 'myPop1',800,800);" href="javascript:void(0);"><img src="/image/footer/colorOptions_footer.png" width="380" height="175" ></a>
...
<?php } ?>
      ...
      <div class="right">
       ...
       <div id="tabs" class="htabs"><a href="#tab-description"><img  src="http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info_on.png" id="imgClickAndChange" onclick="changeImage()"><?php //echo $tab_description; ?></a>
        <?php //if ($attribute_groups) { ?>
        <!--<a href="#tab-attribute"><?php //echo $tab_attribute; ?></a>-->
        <?php //} ?>
        <a href="#tab-specs"><img  src="http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_specs.png" id="imgClickAndChange2" onclick="changeImage3()" ></a>
          <?php if ($attribute_groups) { 
               ...
               ?>
       <!-- <a href="#tab-video">Video</a>-->
        <a href="#tab-shippingInfo"><img  src="http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_shipping.png"   id="imgClickAndChange3" onclick="changeImage2()" ></a>
        <?php if ($review_status) { ?>
        <a href="#tab-review"><img  src="http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_reviews.png" id="imgClickAndChange4" onclick="changeImage2()"  ><?php //echo $tab_review; ?></a>
        <?php } ?>
        <?php if ($products) { ?>
      ...
      <div id="tab-description" class="tab-content">
        ...
        <!--</div>-->
        <?php } ?>
        <sapn itemprop="description"><?php echo $description; ?></span>
      </div> 
      <?php if ($review_status) { ?>
      ...
      <div id="tab-related" class="tab-content">
        ...
        <div id="tab-specs" class="tab-content">
          <div id="specificationTab"><?php if ($product_grouped) { //echo "<pre>";print_r($product_grouped);echo"</pre>"; ?>
            <table id="spec-table">
              <?php
              $shipwidth ="";
              $shipheight ="";
              $shiplength = "";
               foreach ($product_grouped as $product) { 
                $shipwidth .=  ((round($product['width'],2)));
                $shipheight .=  ((round($product['height'],2)));
                $shiplength .=  ((round($product['length'],2)));
                } 

                if ((round($shipwidth)!=0)||(round($shipheight)!=0)||(round($shiplength)!=0)) { ?>
              <tr>
                <th>Sectional Dimensions</th>
                <th>Width</th>
                <th>Height</th>
                <th>Length</th>
              </tr>
              ...
              <?php   if((round($product['width'],2)!=0) && (round($product['height'],2)!=0) && (round($product['length'],2)!=0) ){ ?>

              <tr class="grey">

                <td><?php echo $product['name']; ?></td>
                <td><?php echo round($product['width'],2); ?></td>
                <td><?php echo round($product['height'],2); ?></td>
                <td><?php echo round($product['length'],2); ?></td>
              </tr>
              <?php }} else{ ?>
                <?php   if((round($product['width'],2)!=0) && (round($product['height'],2)!=0) && (round($product['length'],2)!=0) ){ ?>
            ...
            <div>
              ...
              <?php foreach ($attribute_group['attribute'] as $attribute) { ?>
              <?php if($attribute['text']!=""){  ?>
              <strong><?php echo $attribute['name']; ?></strong><?php echo $attribute['text']; ?><br />
              <?php } } } ?>
              <?php }   ?>
              <?php }   ?>
            </div>
           ...
           <?php if ($attribute_groups) { 
            ...
            <div id="tab-shippingInfo" class="tab-content" style="font-family:futura-std-book;">
              <?php if ($attribute_groups) { ?>
              <?php foreach ($attribute_groups as $attribute_group) { ?>
           ...
           <?php if($attribute['attribute_id']=='33'){ ?>
              <strong><?php  echo $attribute['name']; ?></strong><br>
               <?php echo substr($attribute['text'],0,273)."<br><br>"; ?>
              <?php echo (strrchr($attribute['text'],"All Items are factory")); ?><br />
              <?php } else { ?>
            ...
            <div class="product_grouped_right">
              ...
              <form action="<?php echo $this->url->link('checkout/cart/addGroupBundle'); ?>" method="post" enctype="multipart/form-data" id="form-bundle-addtocart">
                ...
                <table class="product_grouped">
                  ...
                  <?php $gp_count=0; 
                  foreach ($product_grouped as $product) { $gp_count++; //echo "<pre>"; print_r($product); ?>
                  <tbody id="gp-tbody<?php echo $product['product_id'] ?>">
                    <tr>

                      <?php if ($product['image_column']) {
                      if($product['real_image']!=''){ ?>
                      <td class="center"><a href="<?php echo $product['real_image']; ?>" title="" class="colorbox"><img onmouseover="Tip('\&lt;img src=<?php echo $product['real_image']; ?> width=550 /\&gt;')" onmouseout="UnTip()" src="<?php echo $product['image']; ?>" /></a></td>
                      <?php } else{ ?>
                     <td class="center"><a href="<?php echo $product['image_column_popup']; ?>" title="" class="colorbox"><img onmouseover="Tip('\&lt;img src=<?php echo $product['image_column_popup']; ?> width=150 /\&gt;')" onmouseout="UnTip()" src="<?php echo $product['image_column']; ?>" /></a></td>
                      ...
                      <td class="left">
                        ...
                        <?php } ?></td>
                        <?php } ?><!-- if option //-->
                        <?php if ( $product['product_price']== '$0.00' ) { ?>
                       ...
                       <?php } ?>
                          ...
                          foreach ($grade_price_product as  $gradepricevalue) {

                             if($gradepricevalue['grouped_product_id']==$product['product_id']){
                             }
                          }
                        //  print_r($grade_price_product);
                          ...
                          <?php } else { ?>
                          <span class="price-old"><?php echo $product['price']; ?></span> <span class="price-new"><?php echo $product['special']; ?></span>
                          <?php } } elseif ( $product['product_price']== '$0.00' ) {  ?>
                          <script>
                          ...
                          var targetWin = window.open (pageURL, title, 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
                             ...
                             <span  class="callforprice"><a onclick="PopupCenter1('/index.php?route=product/product_grouped/callforprice/product_id=<?php echo $product_id; ?>/group_id=<?php echo $product['product_id']; ?>', 'myPop1',400,400);" href="javascript:void(0);"><?php echo "Call for Price"; ?></a></span>
                         ...
                         <?php   } ?>
                          ...
                          <td class="left" nowrap="nowrap">
                            ...
                            <?php  $realprice = str_replace("$", "", $product['product_price']);
                            ...
                            <select id="qty<?php echo $gp_count; ?>" name="quantity[<?php echo $product['product_id']; ?>]" class="qtysum">
                             ...
                             <?php
                              for ($qx = $product['minimum']; $qx <= 5; $qx++) { ?>
                        ...
                        <div class="cart" style="margin-top : -10%;border : none;">
...
<script type="text/javascript"><!--
  ...
  <script type="text/javascript"><!--
    ...
    <script type="text/javascript"><!--
      ...
      <script type="text/javascript"><!--
        ...
        $(document).ready(function(){
          for(i=1; i<righe; i++){
            $('#finalPrice'+i).html($('#disPrice'+i).text());
            $('#finalPrice'+i).show();
          }
        });
  ...
  /*for (i=1; i<righe; i++) {
    finalPrice = parseFloat($('#price'+i).val());
    finalTax = parseFloat($('#extax'+i).val());
    total += $('#qty'+i).val() * finalPrice;
    extax += $('#qty'+i).val() * finalTax;
    qty   += $('#qty'+i).val() * 1;
  }*/
...
<script language="javascript">
    function changeImage() {
        ...
        if (document.getElementById("imgClickAndChange").src == "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info_on.png") 
        {
            document.getElementById("imgClickAndChange").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info.png";
            document.getElementById("imgClickAndChange2").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_specs.png";
             document.getElementById("imgClickAndChange3").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_shipping.png";
              document.getElementById("imgClickAndChange4").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_reviews.png";
        }

         else if (document.getElementById("imgClickAndChange").src == "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info.png") 
        {
            document.getElementById("imgClickAndChange").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info_on.png";
            document.getElementById("imgClickAndChange2").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_specs.png";
             document.getElementById("imgClickAndChange3").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_shipping.png";
              document.getElementById("imgClickAndChange4").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_reviews.png";
        }
        ...
        if (document.getElementById("imgClickAndChange3").src == "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_shipping.png") 
        
        {
            document.getElementById("imgClickAndChange").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info.png";
            document.getElementById("imgClickAndChange2").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_specs.png";
            document.getElementById("imgClickAndChange3").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_shipping_on.png";
            document.getElementById("imgClickAndChange4").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_reviews.png";
        }
        else if (document.getElementById("imgClickAndChange4").src == "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_reviews.png") 
        
        {
            document.getElementById("imgClickAndChange").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info.png";
            document.getElementById("imgClickAndChange2").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_specs.png";
            document.getElementById("imgClickAndChange3").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_shipping.png";
            document.getElementById("imgClickAndChange4").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_reviews_on.png";
        }
    }

    function changeImage3(){

      if (document.getElementById("imgClickAndChange2").src == "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_specs.png") 
        
        {

            document.getElementById("imgClickAndChange").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_info.png";
            document.getElementById("imgClickAndChange2").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_specs_on.png";
            document.getElementById("imgClickAndChange3").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_shipping.png";
            document.getElementById("imgClickAndChange4").src = "http://66.228.60.163/catalog/view/theme/sofa/image/tabimage/productInfoTab_reviews.png";
        }
