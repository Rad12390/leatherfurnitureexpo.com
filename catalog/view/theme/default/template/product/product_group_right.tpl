...
<?php
/*
  #file: catalog/view/theme/default/template/product/product_group_right.tpl
...
<!-- End Grouped Product powered by www.fabiom7.com -->
  ...
  <div id="tab-description" class="tab-content"><?php echo $description; ?></div>      <?php if ($review_status) { ?>
      <div class="review">
  ...
  <div id="tab-review" class="tab-content">
    ...
    <!-- Start Grouped Product powered by www.fabiom7.com 5/6 -->
    ...
    <?php } ?>
    <!-- End Grouped Product powered by www.fabiom7.com 5/6 -->
...
<table class="product_grouped">
  ...
  <tr>
    ...
    <td class="left" nowrap="nowrap">
      ...
      <input type="text" name="" id="" value="0" size="1" readonly="readonly" class="disabled" /> <?php if($button_image){ ?><a title="<?php echo $button_cart_out; ?>"><img src="<?php echo $cart_image_out; ?>" class="gpcart-out" alt="<?php echo $button_cart_out; ?>" /></a><?php }else{ ?><a class="button disabled"><?php echo $button_cart_out; ?></a><?php } ?>
	  <?php } else { ?>
      <input type="text" name="quantity" id="q<?php echo $product['product_id']; ?>" value="<?php echo $product['minimum']; ?>" size="1" /> <?php if($button_image){ ?><a onclick="addToCartG('<?php echo $product['product_id']; ?>');" title="<?php echo $button_cart; ?>"><img src="<?php echo $cart_image_add; ?>" class="gpcart" alt="<?php echo $button_cart; ?>" /></a><?php }else{ ?><a onclick="addToCartG('<?php echo $product['product_id']; ?>');" class="button"><?php echo $button_cart; ?></a><?php } ?>
      <input type="hidden" name="product_id" id="p<?php echo $product['product_id']; ?>" value="<?php echo $product['product_id']; ?>" />
	  <?php } ?>
