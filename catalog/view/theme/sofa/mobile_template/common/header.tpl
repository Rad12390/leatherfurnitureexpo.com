...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
    <head>
        ...
        <!-- spring metrics tracking code   starts-->
        <script type='text/javascript'>
                    var _springMetq = _springMetq || [];
                    _springMetq.push(['id', '39e9d54ac4']);
                    (
                            function(){
        ...
        <!-- spring metrics tracking code ends  -->
...
<!-- End Visual Website Optimizer Asynchronous Code -->
    ...
    <div class="bg"></div>
       ...
       <script type="text/javascript" src="catalog/view/javascript/jquery/wz_tooltip.js"></script>
        ...
        <div class="dim_light"></div>
        
         <div class="topbar clearfix">
                 <a href="tel:+1-800-737-7702" class="callus" style="color: #fff;">1.800.737.7702</a>
                <span class="timeset">10am-9pm est mon-sat <br/>12pm-8pm est sunday</span>
    </div>
        ...
        <div id="container">
            ...
            <div id="header">
                 <div class="login-cont clearfix">
                     <?php if ($logged) { ?>
                        <div class="profile profile_detail">
                            <div class="account-name"> <?php echo $text_logged_name; ?></div>
                            <div><?php echo $text_order; ?></div>
                            <div><?php echo $text_logout; ?></div>
                        </div>
                    <?php } else { ?>
                        <div class="profile profile_not_logged">
                        <div  class="account-name">ACCOUNT</div>
                        <div ><?php echo $text_welcome_login; ?></div>
                        <div><?php echo $text_create_account; ?></div>
                        </div>
                    <?php } ?>
            ...
            <script>
                $(document).ready(function(){
                $(".profile").hide();
                  $(".links-profile").on('click', function(){
                $(".profile").slideToggle(0);
                        $('.dim_light').toggle();
                    });
                    $(".dim_light,.profile").on('click', function(){
                        $('.dim_light,.profile').hide();
                    });
