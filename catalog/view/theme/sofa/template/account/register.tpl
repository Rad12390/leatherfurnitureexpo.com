...
<div id="content" class="login-block"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="register-main-block">
    ...
    <div class="content" style="display:block">
        ...
        <tr>
          ...
          <td><?php if($zone_id){ ?>
              <select name="new_customer_zone_id">
                <option value="<?php echo $zone_id; ?>" selected="selected"><?php echo $zone_id; ?></option>
              </select>
             <?php } else { ?><select name="zone_id"><option><?php echo $zone_id; ?><option>
            </select>
            <?php if ($error_zone) { ?>
      ...
      <div class="row captcha">
            <table class="form">
                <tr>
                    <td><?php echo $entry_captcha; ?><span class="required">*</span></td>
                    <td>
