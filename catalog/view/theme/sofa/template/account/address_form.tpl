<?php echo "dcdsdf"; echo $header; ?><?php echo $column_left; ?><?php echo $column_right; ?>
<div id="content" class="edit-address-form-detail acc-form-dtl"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="clearfix">
    ...
    <div class="buttons clearfix">
      ...
      <div class="right">
        <input type="submit" value="<?php echo $button_continue; ?>" class="btn-blue" />
      </div>
    </div>
  </form>
