...
<?php } ?>
    ...
    <div class="extra-charges applied-coupon">
...
<div id="securitytext" class="clearfix">
    ...
    <div id="cart-2">
            ...
            <div class="Frombox-right">
                ...
                <form action="" id="shipping-information">
                    <h2><?php echo $text_heading_shipping; ?> 
                        <?php if(!$this->customer->isLogged()){ ?> <br><span><input type="checkbox"  name="is_shippingg" id="is_shipping" value="1"/> <?php echo $text_billing_shipping; ?></span><?php } ?></h2> 
                    <div class="controls">
                        <label><?php echo $text_fname; ?> <em><strong>*</strong></em></label>
                        <input type="text" value="" name="shipping_firstname" class="shipping_address_details" />
                    </div>
        ...
        <div class="payment">
            <h2 class="payment_method_heading"> <?php echo $text_payment_method ?></h2>
                ...
                <?php 
                    ...
                    if($payment_methods) {  
                        foreach ($payment_methods as $payment_method) { 
                           $tab.=   '<li  class="payments_method"><a href="#'.$payment_method['code'].'">'.$payment_method['checkout_title'].'</a></li>';
            ...
            success: function (json) {
               ...
               $('.success, .warning, .attention, .error').remove();
                if (json['redirect']) {
                    ...
                    if (json['error']['account_no']) {
                        $('#account_no').append('<span class="error" id="error-card">' + json['error']['account_no'] + '</span>');
                    }
