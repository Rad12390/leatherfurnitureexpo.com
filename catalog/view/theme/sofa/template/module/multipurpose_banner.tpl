...
<div id="multipurpose_banner<?php echo $module; ?>" class="banner">
...
$(document).ready(function() {
	$('#multipurpose_banner<?php echo $module; ?> div:first-child').css('display', 'block');
    });

var banner = function() {
$('#multipurpose_banner<?php echo $module; ?>').cycle({
