...
<div style="width:760px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <?php } else { ?>
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $create_account_link; ?></p>
  <?php } ?>
  <?php if ($download) { ?>
    ...
    <tbody>
      ...
      <tr>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><strong><?php echo $product['main_product_name']; ?></strong><br />
          ...
          <?php } ?></td>
        <td colspan="4" style="padding: 0; vertical-align:top; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; ">
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;"><?php echo $customer_comment_text; ?></td>
      </tr>
    </thead>
    <tbody>
      <tr>
