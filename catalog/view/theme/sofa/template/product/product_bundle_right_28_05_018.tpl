...
<div id="content" class="bundle_right"><?php echo $content_top; ?>
    ...
    <div class="product-info clearfix" itemscope itemtype="http://schema.org/Product">
          ...
          <div  class="youtube"  style="height:78px; width:70px;" id="<?php echo $video['video']; ?>" href="<?php echo $video['video']; ?>" frameborder="0" allowfullsucreen></div>
            ...
            <?php  if($swatch=='yes') { ?>
             ...
             <div style="text-align:center; font-family:century gothic, Verdana, Helvetica, Georgia, Times New Roman, Times, serif; font-size:13px;font-weight:700; margin-bottom:20px;">
                <b><span style="font-size:14px;cursor: pointer; width:100%" class="toolTipV"> WHAT DOES LEATHER GRADING MEAN?</span></b>
            </div>
            ...
            <div id="swatch_sample_text" >
                        <img src="image/footer/samples.png"/>
                    </div>
            <?php } ?>
        </div>
        <?php } ?>
        <div class="right">
          <div id="tabs" class="htabs clearfix">
             <?php if ($attribute_groups) { 
                    ...
                    $tab .= ($id=="Overview") ? '<li><a href="#tab-'.$id.'"><i class="fa fa-server"></i> '.$attribute_group['name'].'</a></li>' : ($id=="Dimensions") ? '<li><a href="#tab-'.$id.'"><i class="fa fa-eraser" aria-hidden="true"></i> '.$attribute_group['name'].'</a></li>' : '<li><a href="#tab-'.$id.'"><i class="fa fa-truck" aria-hidden="true"></i> '.$attribute_group['name'].'</a></li>';
                    ob_start();
              ...
              <tr class="grey">
               <?php if((number_format($product['width'])!=0)||(number_format($product['height'])!=0)||(number_format($product['length'])!=0)){?>
                ...
                <?php }else{ ?>
                  ...
                  $tab .= '<li><a href="#tab-attachment"><i class="fa fa-download" aria-hidden="true"></i> Downloads</a></li>'; ?>
                   <?php     ob_start(); ?>
                 ...
                 $tab_html .= ob_get_contents();
                   ...
                   <?php 
                    ...
                    <li><a href="#tab-youtubelink" class="tab-youtubelink" ><i class="fa fa-youtube-play"></i> video
                        </a>
                ...
                ob_end_clean();
                    ...
                    <?php  if($swatch=='yes') {
                    $tab.='<li><a href="#swatch"> <i class="fa fa-reply-all"></i> Swatch</a> </li>';  ?>
...
<?php } ?> 
 <?php if($bread_status) { ?> 
                    ...
                    <div id='bread-checkout-btn' class="bread-checkout-btn" style="width:198px;"></div>
                   <?php } ?>
                                    </div>
                                    </div>
                                    <!-- End Grouped Product powered by www.fabiom7.com -->
 ...
 <script type="text/javascript">
        ...
        var opts = {
          ...
          //customCSS:'body { margin:0; padding:0; float:right;}.bread-center { display: table;text-align: right;width: 100%} .bread-btn .bread-embed-icon{display:none; } .bread-btn .bread-text { color: #0a0909; font-size: 14px; font-family: "Latosemibold", sans-serif; cursor:pointer; position:relative;} .bread-text.bread-as-low-as::before { content: "As low as :";position: absolute;left: -80px; font-weight: 600; top: 0px;     background: url(../image/bread-logo.png) no-repeat 0 0px;}',
          done: function(err) {
            if (err !== null) {
