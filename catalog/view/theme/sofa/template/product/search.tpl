...
<div class = "search_bread">
 ...
 <!-- <b><?php echo $text_critea; ?></b>-->
  <div class="search-prd">
    <p class="search-page clearfix">
    <span class="search-area"><?php echo $entry_search; ?>
      <?php if ($search) { ?>
    ...
    <?php } ?>
     ...
     <input type="button" value="<?php echo $button_search; ?>" id="button-search" class="btn-blue" />
    </p>
 ...
 <!-- <div class="buttons">
  ...
  <div class="text_search">  <h2><?php echo $text_search; ?></h2></div>
