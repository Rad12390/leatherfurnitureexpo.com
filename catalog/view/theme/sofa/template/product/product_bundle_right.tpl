...
<div id="content" class="bundle_right"><?php echo $content_top; ?>
    ...
    <span itemprop="description"></span>
        ...
        <div class="clearfix">
            ...
            <div class= "sku"><?php echo ( $product_grouped[0]['grouped_sku'] ? "SKU:" . $product_grouped[0]['grouped_sku'] : '' ); ?></div>
        </div>
          ...
          <div  class="youtube"  style="height:78px; width:70px;" id="<?php echo $video['video']; ?>" href="<?php echo $video['video']; ?>" frameborder="0" allowfullsucreen></div>
            ...
            <?php } ?>  
                ...
                <?php if ($swatch == 'yes') { ?>
                    ...
                    <!-- <div id="swatch_text"><b><span class="toolTipV"> WHAT DOES LEATHER GRADING MEAN?</span></b></div> -->
                    ...
                    <div id="swatch_sample_text" >
                        <img src="image/footer/samples-arrive.png"/>
                    </div>
                <?php } ?>
            </div>
        <?php } ?>
