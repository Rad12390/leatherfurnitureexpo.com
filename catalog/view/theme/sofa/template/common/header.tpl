            ...
            <div id="header">
                ...
                <div class="login-cont clearfix">
                    ...
                    <div class="links res-menu dropdown" id="links">
                     ...
                     <a href="tel:+1-800-737-7702" class="info_callus clearfix"><i class="fa fa-phone" aria-hidden="true"></i> <span>1.800.737.7702</span></a>
                        <?php   if (!$logged) { ?>
                      ...
                      <?php } ?>
       <a title="<?php echo $text_shopping_cart; ?>" class="links-cart clearfix" href="<?php echo $shopping_cart; ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span><?php echo $text_shopping_cart; ?></span></a>
