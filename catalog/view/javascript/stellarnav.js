...
(function ($) {
    ...
    $.fn.stellarNav = function (options, width, breakpoint) {
        ...
        return this.each(function () {
            ...
            nav.prepend('<a href="#" class="menu-toggle"><i class="fa fa-bars menu-icon"></i></a>');
            //nav.prepend('<a href="#" class="menu-toggle"><span class="icon-bar one"></span><span class="icon-bar second"></span><span class="icon-bar third"></span></a>');



//e.scrollbarFix && n("body").addClass("stellarnav-noscroll-x"), nav.find(".callus").before('<a href="#" class="menu-toggle"><span class="icon-bar one"></span><span class="icon-bar second"></span><span class="icon-bar third"></span></a>')
            ...
            $('.menu-toggle').on('click', function (e) {
                ...
                nav.find('.menu-icon').toggleClass('fa-times').toggleClass('fa-bars');
