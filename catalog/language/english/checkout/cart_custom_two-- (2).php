...
class ControllerCheckoutCartCustomTwo extends Controller {
    ...
    public function index() {
        ...
        $this->data['text_credit_cart'] = $this->language->get('text_credit_cart');
        $this->data['text_paypal'] = $this->language->get('text_paypal');
        $this->data['text_affirm'] = $this->language->get('text_affirm');
        $this->data['text_bread'] = $this->language->get('text_bread');
