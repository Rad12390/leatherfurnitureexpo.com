...
// S 2/7 //
            ...
            $this->document->addLink($this->url->link('product/product', 'product_id=' . $this->request->get['product_id']), 'canonical');
                $this->data['server'] =  HTTP_SERVER; 
                $k=$this->config->get('bread_api_key');
            if (VERSION > '1.5.4.1') {
               ...
               // $this->document->addScript('catalog/view/javascript/jquery/tabs.js');
                 ...
                 $this->document->addScript('catalog/view/javascript/product_bundle_right.js','footer');
                 $this->document->addScript('catalog/view/javascript/jquery/ajaxupload.js','footer');
                 $this->document->addScript('https://www.youtube.com/player_api','footer');
...
// S 5/7 //
    ...
    foreach ($gruppi as $gruppo) {
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product_' . $temtab . '_' . $temtabpos . '.tpl')) {
