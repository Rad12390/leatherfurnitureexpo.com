...
require_once(DIR_SYSTEM . 'library/swiftmailer/swiftmailer/lib/swift_required.php');
...
class Mail {
    ...
    public function send() {
        if (class_exists('Swift', true)) {
            if ($this->protocol == 'mail') {
                $transport = Swift_MailTransport::newInstance();
            } else {

                //$transport = Swift_SmtpTransport::newInstance($this->hostname, $this->port, "ssl")
            ...
            $message = Swift_Message::newInstance($this->subject)->setFrom(array($this->from => $this->sender))
                    ->setTo($this->to)
                    ->setSubject($this->subject);

            if ($this->replyto) {
                (($this->replytoname) ? $message->setReplyTo(array($this->replyto => $this->replytoname)) : $message->setReplyTo($this->replyto));
            } else {
                $message->setReplyTo(array($this->from => $this->sender));
            }
            

//            if ($this->replyto != '' && $this->replytoname != '') {
//                $message->setReplyTo(array($this->replyto => $this->replytoname));
//            } else {
//                $message->setReplyTo(array($this->from => $this->sender));
//            }
            if ($this->html) {
                ...
                $message->addPart('This is a HTML email and your email client software does not support HTML email!', 'text/plain');
            }
