    ...
    <div class="content">
      ...
      <div id="tab-extra">
        <table class="form">
          ...
          <tr>
            <td width="25%"><?php echo $this->language->get('Exclude inactive products'); ?></td>
            <td>
          ...
          <tr>
            <td width="25%"><?php echo $this->language->get('Exclude products with zero quantity'); ?></td>
            <td>
...
//--></script> 
    ...
    <div class="content">
      ...
      <div id="tabs" class="htabs">
        ...
        <a href="#tab-options"><?php echo $this->language->get('Options'); ?></a>
         <a href="#tab-group_product_general">Grouped Product General</a>
        <a href="#tab-group_product">Grouped Products</a>
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" value="Y" name="columns[general][<?php echo $v['field']; ?>][checked]" 
                  <?php if (!empty($v['required']) || !empty($columns['general'][$v['field']]['checked'])) { ?> onclick="return false" <?php } ?> 
        ...
        <div id="tab-group_product_general">
        ...
        <table class="list">
          ...
          <thead>
            <tr>
              <td class="left" width="25%"><?php echo $this->language->get('Product Field'); ?></td>
              <td><?php echo $this->language->get('Column in File'); ?></td>
              <td>Include <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[group_products_general]&quot;]').attr('checked','checked');"><?php echo $this->language->get('all'); ?></a>
              / <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[group_products_general]&quot;]').not('[disabled=&quot;disabled&quot;]').removeAttr('checked');"><?php echo $this->language->get('none'); ?></a>)</td>
              <td width="50%"><?php echo $this->language->get('Notes'); ?></td>
            </tr>
          </thead>
           <?php foreach($group_products_general as $key=>$gp_val) { 
             if (!empty($columns['group_products_general'][$gp_val['field']]['column'])) {
              $gp_val['column'] = $columns['group_products_general'][$gp_val['field']]['column'];
            } else {
              $gp_val['column'] = $gp_val['field'];
            }      
           
           ?>
 <tr>
              <td width="25%">
              <?php echo $gp_val['name'];?>
              <?php if (!empty($gp_val['required'])) { ?><span class="required">*</span><?php } ?>
              </td>
              <td>
                <input type="input" value="<?php echo $key; ?>" name="columns[group_products_general][<?php echo $gp_val['field']; ?>][column]" />
              </td>
              <td>
                <!---<input type="checkbox" value="Y" name="columns[group_products_general][<?php echo $gp_val['field']; ?>][checked]" 
                 
                  <?php if (!empty($gp_val['required']) || !empty($columns['group_products_general'][$gp_val['field']]['checked'])) { ?> checked="checked" <?php } ?> 
                /> -->
                <input type="checkbox" value="Y" name="columns[group_products_general][<?php echo $gp_val['field']; ?>][checked]" checked="checked" />
              </td>
              <td width="50%"><span class="help"> <?php echo $gp_val['descr'];?> </span></td>
            </tr>
            <?php } ?>
          <tbody>
        ...
        <table class="list">
          ...
          <thead>
            <tr>
              <td class="left" width="25%"><?php echo $this->language->get('Product Field'); ?></td>
              <td><?php echo $this->language->get('Column in File'); ?></td>
              <td>Include <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[group_products]&quot;]').attr('checked','checked');"><?php echo $this->language->get('all'); ?></a>
              / <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[group_products]&quot;]').not('[disabled=&quot;disabled&quot;]').removeAttr('checked');"><?php echo $this->language->get('none'); ?></a>)</td>
              <td width="50%"><?php echo $this->language->get('Notes'); ?></td>
            </tr>
          </thead>
           <?php foreach($group_products as $key=>$gp_val) { 
            if (!empty($columns['group_products'][$gp_val['field']]['column'])) {
              $gp_val['column'] = $columns['group_products'][$gp_val['field']]['column'];
            } else {
              $gp_val['column'] = $gp_val['field'];
            }     
           ?>
 <tr>
              ...
              <td>
                <input type="input" value="<?php echo $key; ?>" name="columns[group_products][<?php echo $gp_val['field']; ?>][column]" />
              </td>
              <td>
                <!--<input type="checkbox" value="Y" name="columns[group_products][<?php echo $gp_val['field']; ?>][checked]" 
                   
                  <?php if (!empty($gp_val['required']) || !empty($columns['group_products'][$gp_val['field']]['checked'])) { ?> checked="checked" <?php } ?> 
                /> -->
                <input type="checkbox" value="Y" name="columns[group_products][<?php echo $gp_val['field']; ?>][checked]" checked="checked" />
              </td>
              <td width="50%"><span class="help"> <?php echo $gp_val['descr'];?> </span></td>
            </tr>
            <?php } ?>
