...
//--></script> 
    ...
    <div class="content">
      ...
      <div id="tabs" class="htabs">
        ...
        <a href="#tab-grouped-products-general">Grouped Products General</a>
        <a href="#tab-grouped-products">Grouped Products</a>
      ...
      <div id="otab-extended_format">
        ...
        <table class="list">
         ...
         <div id="tab-grouped-products-general">
...
<br /><br />
        ...
        <table class="list">
          <thead>
            <tr>
              <td class="left" width="25%">Field Name</td>
              <td>Column in File</td>
              <td width="50%">Notes</td>
            </tr>
          </thead>
          ...
          <?php  foreach($grouped_products_general as $dk => $dv) { ?>
            <tr>
              <td width="25%"><?php echo $dv['name'] ?></td>
              <td>
                <?php  echo $this->showSelector("grouped_products_general[$dv[field]]", $columns, $params['matches']['grouped_products_general'][$dk]['column']); ?>
              </td>
              <td width="50%"><span class="help"><?php echo $dv['descr']; ?></span></td>
            </tr>
          <?php } ?>
...
<br /><br />
        ...
        <table class="list">
          ...
          <?php  foreach($grouped_products as $dk => $dv) { ?>
            <tr>
              <td width="25%"><?php echo $dv['name'] ?></td>
              <td>
                <?php  echo $this->showSelector("grouped_products[$dv[field]]", $columns, $params['matches']['grouped_products'][$dk]['column']); ?>
              </td>
              <td width="50%"><span class="help"><?php echo $dv['descr']; ?></span></td>
            </tr>
          <?php } ?>
