         ...
         <!--  <li><a href="<?php echo $profile; ?>"><?php echo $text_profile; ?></a></li>-->
          <li><a class="parent"><?php echo $text_attribute; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $attribute_production_time; ?>"><?php echo $text_attribute_production_time; ?></a></li>
        ...
        <ul>
          ...
          <li><a class="parent"><?php echo $text_product; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $report_downloaded; ?>"><?php echo $text_report_downloaded; ?></a></li>
            </ul>
          </li>
          <li><a class="parent"><?php echo $text_customer; ?></a>
            <ul>
          ...
          <li><a class="parent"><?php echo $text_affiliate; ?></a>
            <ul>
              <li><a href="<?php echo $report_affiliate_commission; ?>"><?php echo $text_report_affiliate_commission; ?></a></li>
                    ...
                    <li><a  href="<?php echo $report_swatch_system; ?>"><?php echo $text_swatch; ?></a></li>
                                        <li><a  href="<?php echo $report_call_price; ?>"><?php echo $text_callforprice; ?></a></li>
