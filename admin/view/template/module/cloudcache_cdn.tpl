  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <table class="form">
            <tr>
                <td> <b><?php echo $text_image_setting; ?></b></td><td>&nbsp;</td>
            </tr>
        <tr>
        ...
        <table class="form">
            <tr>
                <td> <b><?php echo $text_data_type_setting; ?></b></td><td>&nbsp;</td>
            </tr>
              <tr>
        	<td><?php echo $entry_cdn_domain1; ?></td>
        	<td><input type="text" name="cdn_domain_data_type" size="50" value="<?php echo $cdn_domain_data_type; ?>"/></td>
        </tr>
        <tr>
