            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    <tr>
                        ...
                        <td><select name="customcheckout[status]">                    
                                <?php 
                                if(!empty($modules)){
                                if($modules['status']==2) { ?>
                                <option selected value="2">Disable</option>
                                <option value="1">Enable</option>
                                <?php } elseif($modules['status']==1){ ?>
                ...
                <!--<table id="module" class="list">
                  ...
                  <tbody id="module-row<?php echo $module_row; ?>">
                    <tr>
                      <td class="left"><select name="multiplecart[<?php echo $module_row; ?>][layout_id]">
                      ...
                      <td class="left"><select name="multiplecart[<?php echo $module_row; ?>][position]">
                      ...
                      <td class="left"><select name="multiplecart[<?php echo $module_row; ?>][status]">
