          ...
          <tr> 
            ...
            <td class="left"><select name="newslettersubscribe_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="left">
                                ...
                                <?php echo $entry_phone_device; ?> <input type="checkbox"   name="newslettersubscribe_module[<?php echo $module_row; ?>][device][phone]" value="1"  <?php echo ($module['device']['phone'] ? 'checked' : '');?>/> 
                                 <?php  echo $entry_tablet_device;?> <input type="checkbox"    name="newslettersubscribe_module[<?php echo $module_row; ?>][device][tablet]" value="1" <?php echo ($module['device']['tablet'] ? 'checked' : '');?>/> 
                               <?php  echo $entry_computer_device; ?> <input type="checkbox"    name="newslettersubscribe_module[<?php echo $module_row; ?>][device][computer]" value="1"  <?php echo ($module['device']['computer'] ? 'checked' : '');?>/> 
                            </td>
...
function addModule() {	
	...
	html += '    </select></td>';
         html += '    <td class="left"> <?php echo $phone_device ?>  <input type="checkbox" name="banner_module[' + module_row + '][device][phone]"  value="1">\n\
                                        <?php echo $tablet_device ?>   <input type="checkbox" name="banner_module[' + module_row + '][device][tablet]"   value="1">\n\
                                        <?php echo $computer_device ?>  <input type="checkbox" name="banner_module[' + module_row + '][device][computer]"   value="1"></td>'
