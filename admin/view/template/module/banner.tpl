                    ...
                    <tbody id="module-row<?php echo $module_row; ?>" >
                        <tr>
                            ...
                            <td class="left">
                                ...
                                <?php echo $entry_phone_device; ?> <input type="checkbox"     name="banner_module[<?php echo $module_row; ?>][device][phone]" value="1"  <?php echo ($module['device']['phone'] ? 'checked' : ''); ?>/> 
                                 <?php  echo $entry_tablet_device;?> <input type="checkbox"    name="banner_module[<?php echo $module_row; ?>][device][tablet]" value="1" <?php echo ($module['device']['tablet'] ? 'checked' : '');?>/> 
                               <?php  echo $entry_computer_device; ?> <input type="checkbox"    name="banner_module[<?php echo $module_row; ?>][device][computer]" value="1"  <?php echo ($module['device']['computer'] ? 'checked' : '');?>/> 
                            </td>
...
var module_row = <?php echo $module_row; ?> ;
            function addModule() {
                ...
                html += '    </select></td>';
                html += '    <td class="left"> <?php echo $entry_phone_device ?>  <input type="checkbox" name="banner_module[' + module_row + '][device][phone]"  value="1">\n\
                                        <?php echo $entry_tablet_device ?>   <input type="checkbox" name="banner_module[' + module_row + '][device][tablet]"   value="1">\n\
                                        <?php echo $entry_computer_device ?>  <input type="checkbox" name="banner_module[' + module_row + '][device][computer]"   value="1"></td>'
