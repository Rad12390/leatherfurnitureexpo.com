      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'p.osn') { ?>
                <a href="<?php echo $sort_osn; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_osn; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_osn; ?>"><?php echo $column_osn; ?></a>
                <?php } ?></td>
          ...
          <tbody>
              ...
              <td><input type="text" name="filter_osn" value="<?php echo $filter_osn; ?>" /></td>
            ...
            <tr>
              ...
              <td class="left"><?php echo $product['osn']; ?></td>
...
function filter() {
	...
	if (filter_name) {
        ...
        var filter_osn = $('input[name=\'filter_osn\']').attr('value');
	
	if (filter_osn) {
		url += '&filter_osn=' + encodeURIComponent(filter_osn);
	}
...
$('input[name=\'filter_name\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/product_grouped/product_grouped_autocomplete&token=<?php echo $_GET['token']; ?>&filter_name=' +  encodeURIComponent( '%'+request.term),  // pass % before filter name 
			dataType: 'json',
