...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab-product-category"><?php echo "Category Sort"; ?></a></div>
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left" colspan="2"><?php echo "Price"; ?></td>           
              <td class="left"><?php echo "Number of grouped product"; ?></td>
             <td class="left"><?php echo "Sort"; ?></td>
          ...
          <tbody>  
           <?php if ($products) { ?>
            <?php foreach ($products as $product) {  if($product['name']!=""){//echo "<pre>"; print_r($product['product_id']);  ?>
            <tr>
             
              <td class="center"><img src="<?php echo $product['image']; ?>" alt="" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
              <td class="left"><a class="quick_link_cat" href="<?php echo HTTP_SERVER; ?>index.php?route=catalog/product_grouped/update&token=<?php echo $_GET['token']; ?>&product_id=<?php echo $product['product_id']; ?> "><?php echo $product['name']; ?></a></td>
              ...
              <?php if($product['category_sort']!=0){ ?>
                <td><input type="text" name="cat_sort<?php echo $product['product_id'];  ?>" value="<?php echo $product['category_sort']; ?>" size="7" /></td>
            <?php  } else { ?>
                <td><input type="text" name="cat_sort<?php echo $product['product_id'];  ?>" value="99" size="7" /></td>

             <?php }  ?>
              <td> <input type="hidden" name="product_id<?php echo $product['product_id'];  ?>" value="<?php echo $product['product_id'];  ?>" size="7" /></td>
