        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><?php if ($exclude_status) { ?>
               <input type="checkbox" onclick="update_status(this.value, this);" name="exclude_status" value="1" checked="checked" />               <?php } else { ?>
                <input type="checkbox" onclick="update_status(this.value, this);" name="exclude_status" value="" />
                <?php } ?></td>
            </tr>
...
//--></script>
<script type="text/javascript">
    function update_status(val, name)
    {
        if(val == '' || val == 0)
        {
            jQuery(name).val(1);
