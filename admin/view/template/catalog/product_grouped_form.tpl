    ...
    <div class="box">
        ...
        <div class="content">
            <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a>
                ...
                <a href="#tab-video"><?php echo $entry_video; ?></a>
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <div id="tab-data">
                    <table class="form">
                        ...
                        <tr>
                          <td>Youtube Video Url<br/> <span class="help">(i.e. https://www.youtube.com/watch?v=MXdfrT  then just enter MXdfrT )</td>
...
<div id="tab-video">
                      <table id="videos" class="list">
                        <thead>
                          <tr>
                            <td class="left"><?php echo $entry_video; ?><br/> <span class="help">(i.e. https://www.youtube.com/watch?v=MXdfrT  then just enter MXdfrT )</td>
                       ...
                       <?php foreach($product_videos as $product_video) { ?>
                        <tbody id="video-row<?php echo $video_row; ?>">
                         <tr>
                          ...
                          <td><input type="text" name="product_video[<?php echo $video_row; ?>][link]" value="<?php echo $product_video['video_link']; ?>" style="width:350px"/></span></td>
                                    ...
                                    <table class="form">
                                        <tr>
                                          <td>
                                              ...
                                              <input type="text" style="width:500px;" name="product_notes">
                                              
                                          </td>
                                        </tr>
                                        <tr>
                                            <td><?php $p_id = $_REQUEST['product_id']; ?><a type="button" class="button" onclick="addMe('<?php echo $p_id; ?>')">Add Note</a>
                                            <span style="padding:0 10px 0 0; display:inline-block;">
                                                <img id="loading_image_add" style="display:none;" src="view/image/loading.gif"/>
                                            </span>
                                        </tr>
                                    </table>
                                    
                                    <table class="list notes-details" id="product_notes">
                                    <thead>
                                      <tr>
  ...
  $('#product-download div:even').attr('class', 'even');  
                       ...
                       <script type="text/javascript">
                            ...
                            function addVideo() {
                             ...
                             html += '<td><input type="text" name="product_video['+video_row +'][link]" value="<?php echo $youtubevideo; ?>" style="width:350px"/></td>';
...
<script type="text/javascript"><!--
    ...
    function addMe(product_id){
        
        
        product_notes = $('input[name="product_notes"]').val();
        if(product_notes == '')
        {
            alert('Add note text missing');
            return false;
        }
        $('#loading_image_add').css('display', 'block');
        $.ajax({ 
            url: 'index.php?route=catalog/product_grouped/addProductNote&token=<?php echo $token; ?>&product_id='+product_id,
                type: 'post',
                data: 'product_notes='+product_notes,
                success: function(data)
                {  
                $.ajax({
                    url: 'index.php?route=catalog/product_grouped/getProductNotes&token=<?php echo $token; ?>&product_id='+product_id,
                    type: 'post',
                    success: function(data)
                    {  
                        $('#product_notes').html(data);
                        $('#loading_image_add').css('display', 'none');
                        $('input[name="product_notes"]').val('');
                    }
                });
                }
            });
