          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($color['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="center"><img src="<?php echo $color['image']; ?>" alt="<?php echo $color['name']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
...
function filter() {
	url = 'index.php?route=catalog/color&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/color/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
