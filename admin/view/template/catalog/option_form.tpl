  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <table id="option-value" class="list color-table-box">
          <thead>
            <tr>
              <td class="left"><span class="required">*</span> <?php echo $entry_option_value; ?></td>
              <td class="left"><?php echo $entry_image; ?></td>
              <td class="right"><?php echo "Disable:"; ?></td>
          ...
          function compareByName($option_values, $b) {
        return strcmp($option_values['option_value_description']['1']["name"], $b['option_value_description']['1']["name"]);
}
          usort($option_values, 'compareByName');
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
           <tr>
              ...
              <td class="right"><input type="checkbox" name="option_value[<?php echo $option_value_row; ?>][status]" <?php if($option_value['status'] == 1) echo 'checked'; ?> value="<?php echo $option_value['status']; ?>" onclick="change_value(this.value, this)"/></td>    
...
function addOptionValue() {
	...
	html += '    <td class="right"><input type="checkbox" name="option_value[' + option_value_row + '][status]" value="" size="1" /></td>';
...
function change_value(val, val2)
{
    if(val == '' || val == 0)
    {
        jQuery(val2).val(1);
        console.log(jQuery(val2).val());
    }
    else
    {
        jQuery(val2).val(0);
