  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
          ...
          <a href="<?php echo $insert_customer_coupon; ?>" class="button"><?php echo $button_insert; ?></a>
          <!--a onclick="document.getElementById('form').submit();" class="button"><?php echo $button_delete; ?></a--></div>
    </div>
    <div class="content">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($coupon['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><a href="javascript:void" name="<?php echo $coupon['code']; ?>" onclick="setcouponValue(this.name)"><?php echo $coupon['name']; ?></a></td>
...
<script type="text/javascript">
    ...
    function setcouponValue(coupanValue){
