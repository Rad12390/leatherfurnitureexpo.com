...
<div id="content">
    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons"><a href="<?php echo $sendinvoice; ?>" target="_blank" class="button"><?php echo $button_sendinvoice; ?></a><a href="<?php echo $invoice; ?>" target="_blank" class="button"><?php echo $button_invoice; ?></a><a href="<?php echo $historyinvoice; ?>" target="_blank" class="button"><?php echo $button_history_invoice; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
        </div>
        <div class="content">
            <div class="vtabs"><a href="#tab-order"><?php echo $tab_order; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a>
                ...
                <a href="#tab-admin_history"><?php echo "Admin History"; ?></a>
                <?php if ($maxmind_id) { ?>
            ...
            <div id="tab-product" class="vtabs-content">
                <table class="list" width="100%">
                    ...
                    <tbody>
                        ...
                        <?php foreach($cart_detail as $main_products) {
                    ...
                    <tbody id="totals">
                        <tr>
                            ...
                            <td class="right" style="padding:0;" colspan="3"><?php echo $totals['text']; ?></td>
                        </tr>
                    </tbody>
                    <?php } ?>
                </table>
                ...
                <table class="form">
                    <tr> 
                        ...
                        <td>
                            ...
                            <select name="order_status_id" id="order_status_id" onchange="showUser(this.value)">
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" id="ntotify_check" name="notify" value="1" onchange="showHideTexarea()" /></td>
                    </tr>
                    <tr id="notify_email_div" style="display:none">
                        <td>Notify Customer Email Template:</td>
                        <td><div id=""> <textarea name="comment_value" id="comment_value" cols="40" rows="8" style="width: 99%"></textarea></div></td>
                    </tr>
                    <tr>
                        <td id="comment_label_td"><?php echo $entry_comment; ?></td>
                        <td>
                         <span id="comment_span"><textarea name="comment" id="comment" cols="40" rows="8" style="width: 99%"></textarea></span>
                         <div style="margin-top: 10px; text-align: right;"><button id="button-history" class="button"><?php echo $button_add_history; ?></button></div>
                        </td>
                    </tr>
                </table>
            </div>
              <div id="tab-admin_history" class="vtabs-content">
                <div id="admin_history"></div>
                </div>
            <?php if ($maxmind_id) { ?>
...
<script type="text/javascript">
    function showHideTexarea()
    {
      $('#notify_email_div').toggle();
      if($('#ntotify_check').is(':checked')==true)
      {
        //$('#comment_label_td').html('&nbsp;'); 
        //$('#comment').hide();  
      }
      else
      {
          $('#comment_label_td').html('<?php echo $entry_comment; ?>');
          $('#comment').show();
      }
    }
</script>
...
$('#invoice-generate').live('click', function() {
    ...
    $('#history').load('index.php?route=sale/customorder/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
    $('#admin_history').load('index.php?route=sale/customorder/admin_history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
    ...
    $.ajax({
    url: 'index.php?route=sale/customorder/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
            type: 'post',
            dataType: 'html',
...
xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");
                            ...
                            document.getElementById("comment_value").value = xmlhttp.responseText;
