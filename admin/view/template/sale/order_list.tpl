        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right" style="width:4%;"><?php if ($sort == 'o.order_id') { ?>
              ...
              <td class="left"><?php if ($sort == 'customer') { ?>
                ...
                <?php } ?></td>
              <td class="left" style="width:6%;">Telephone</td>
              ...
              <td class="right"><?php if ($sort == 'o.total') { ?>
                ...
                <?php } ?></td>
              <td class="left" style="width:12%;"><?php if ($sort == 'o.date_added') { ?>
            ...
            <td class="left"><?php if ($sort == 'o.date_modified') { ?>
                ...
                <?php } ?></td>
              <td class="right" style="width:7%; "><?php echo $column_action; ?></td>
            </tr>
          </thead>
          <tbody>
            <tr class="filter">
              ...
              <td></td>
              <td><select name="filter_order_status_id" style="width: 130px;">
                  <option value="*"></option>
            ...
            <tr class="<?php echo  ( ($order['credit_card_number'] && $order['card_verification_value']) ? 'not-masked' : '' )?>" >
              ...
              <td class="left"><?php echo $order['ordered_products']; ?></td>
...
<style>
    table .not-masked td {
        background-color:#eaa7a7 !important;
    }
    </style>
...
//--></script> 
<script type="text/javascript"><!--
$('#form input, #filter_common').keydown(function(e) {
...
//--></script> 
<script> 
    function validate_report(report_action) {
...
function validate_invoice(report_action) {
        $('#form').attr('action', report_action);
        var a = $('input[name="selected[]"]:checked').length;
        if (a == 0) {
            alert("Please select at least one Record to print");
