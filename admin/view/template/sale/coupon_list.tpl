        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'cd.name') { ?>
                ...
                <?php } ?></td>
              <td class="left" width="70"><?php if ($sort == 'c.date_expire') { ?>
              ...
              <td class="left"><?php if ($sort == 'c.date_end') { ?>
                ...
                <?php } ?></td>
              <td class="left">Excluded Category</td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left" width="66"><?php echo $coupon['date_expire']; ?></td>
              ...
              <td class="left"><?php 
                  foreach($coupon['coupon_exclude_categories'] as $key=>$coupon_exclude_category)
                   { echo  (  $key  ? ', ' : '') .$coupon_exclude_category ; } ?></td>
