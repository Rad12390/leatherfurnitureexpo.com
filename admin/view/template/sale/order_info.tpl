      ...
      <div id="tab-history" class="vtabs-content">
        ...
        <table class="form">
          <tr> 
            ...
            <td>
<?php //var_dump(strip_tags(html_entity_decode($order_statuses[5]['mail'], ENT_QUOTES, 'UTF-8')));  ?>
  ...
  <select name="order_status_id" id="order_status_id" onchange="showUser(this.value)">
          ...
          <tr>
            ...
            <td><div id="comment_value" contenteditable><textarea name="comment" id="comment" cols="40" rows="8" style="width: 99%"></textarea></div>
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("comment_value").innerHTML=xmlhttp.responseText;
    }
  }
