      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_date_expire; ?></td>
              <td><input type="text" name="date_expire" value="<?php echo $date_expire; ?>" size="12" id="date-expire" /></td>
            </tr>
            <tr>
...
$('#date-expire').datepicker({dateFormat: 'yy-mm-dd'});
//--></script>
<?php if ($coupon_id) { ?>
<script type="text/javascript"><!--
