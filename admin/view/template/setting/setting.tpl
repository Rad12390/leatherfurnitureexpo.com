      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-option">
          ...
          <table class="form">
            ...
            <tr>
                <td><?php echo $entry_checkout_image; ?></td>
                 <td><?php if ($checkout_image) { ?>
                <input type="radio" name="checkout_image" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="checkout_image" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="checkout_image" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="checkout_image" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>            
            <tr> 
                <td><?php echo $text_display_product_starting_price_on_category_page; ?></td>            
                      <td><?php if ($config_display_product_starting_price_on_category_page ) { ?>
                <input type="radio" name="config_display_product_starting_price_on_category_page" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_product_starting_price_on_category_page" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_product_starting_price_on_category_page" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_product_starting_price_on_category_page" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>        
          </table>
        ...
        <div id="tab-image">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_checkout_images; ?></td>
              <td><div class="image"><img src="<?php echo $checkout_images; ?>" alt="" id="thumb-checkout_images" />
                  <input type="hidden" name="config_checkout_images" value="<?php echo $config_checkout_images; ?>" id="checkout_images" />
                  <br/>
                  <a onclick="image_upload('checkout_images', 'thumb-checkout_images');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-checkout_images').attr('src', '<?php echo $no_image; ?>'); $('#checkout_images').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
              <td><?php echo $entry_mobile_checkout_images; ?></td>
              <td><div class="image"><img src="<?php echo $mobile_checkout_images; ?>" alt="" id="thumb-mobile_checkout_images" />
                  <input type="hidden" name="config_mobile_checkout_images" value="<?php echo $config_mobile_checkout_images; ?>" id="mobile_checkout_images" />
                  <br/>
                  <a onclick="image_upload('mobile_checkout_images', 'thumb-mobile_checkout_images');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-mobile_checkout_images').attr('src', '<?php echo $no_image; ?>'); $('#mobile_checkout_images').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
        ...
        <div id="tab-mail">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_mail_on_order_statuses_set_to_furniture_shipped; ?></td>
              <td><?php if ($config_mail_on_order_statuses_set_to_furniture_shipped) { ?>
                <input type="radio" name="config_mail_on_order_statuses_set_to_furniture_shipped" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_mail_on_order_statuses_set_to_furniture_shipped" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_mail_on_order_statuses_set_to_furniture_shipped" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_mail_on_order_statuses_set_to_furniture_shipped" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_emails_on_order_status_furniture_shipped; ?></td>
              <td><textarea name="config_emails_on_order_status_furniture_shipped" cols="40" rows="5"><?php echo $config_emails_on_order_status_furniture_shipped; ?></textarea></td>
            </tr>
          </table>
        </div>
        <div id="tab-fraud">
