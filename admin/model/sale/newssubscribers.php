...
class ModelSalenewssubscribers extends Model {
  ...
  UNIQUE KEY `Index_2` (`email_id`)
	...
	public function addEmail($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "subscribe SET email_id='".$data['email_id']."',name='".$data['email_name']."', date= '".date('m-d-Y')."'");
	}
	...
	public function getEmails($data,$start,$limit) {
		...
		$sql = "SELECT * FROM " . DB_PREFIX . "subscribe  order by id DESC LIMIT $start,$limit";
