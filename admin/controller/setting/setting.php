...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_checkout_image'] = $this->language->get('entry_checkout_image');
		$this->data['entry_checkout_images'] = $this->language->get('entry_checkout_images');
		$this->data['entry_mobile_checkout_images'] = $this->language->get('entry_mobile_checkout_images');
		...
		$this->data['text_smtp'] = $this->language->get('text_smtp');
                $this->data['text_display_product_starting_price_on_category_page'] = $this->language->get('text_display_product_starting_price_on_category_page');
		...
		$this->data['entry_mail_on_order_statuses_set_to_furniture_shipped'] = $this->language->get('entry_mail_on_order_statuses_set_to_furniture_shipped');
		$this->data['entry_emails_on_order_status_furniture_shipped'] = $this->language->get('entry_emails_on_order_status_furniture_shipped');
		...
		if (isset($this->request->post['config_download'])) {
			...
			$this->data['config_download'] = $this->config->get('config_download');
                ...
                if (isset($this->request->post['checkout_image'])) {
			$this->data['checkout_image'] = $this->request->post['checkout_image'];
		} else {
			$this->data['checkout_image'] = $this->config->get('checkout_image');
		}
		...
		$this->data['customer_groups'] = $this->model_sale_customer_group->getCustomerGroups();
                ...
                if (isset($this->request->post['config_display_product_starting_price_on_category_page'])) {
			$this->data['config_display_product_starting_price_on_category_page'] = $this->request->post['config_display_product_starting_price_on_category_page'];
		} else {
			$this->data['config_display_product_starting_price_on_category_page'] = $this->config->get('config_display_product_starting_price_on_category_page');			
		}
		...
		if ($this->config->get('config_icon') && file_exists(DIR_IMAGE . $this->config->get('config_icon')) && is_file(DIR_IMAGE . $this->config->get('config_icon'))) {
			...
			$this->data['icon'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
                 ...
                 if (isset($this->request->post['config_checkout_images'])) {
			$this->data['checkout_images'] = $this->request->post['config_checkout_images'];
		} else {
			$this->data['config_checkout_images'] = $this->config->get('config_checkout_images');			
		     }
		if ($this->config->get('config_checkout_images') && file_exists(DIR_IMAGE . $this->config->get('config_checkout_images')) && is_file(DIR_IMAGE . $this->config->get('config_checkout_images'))) {
			$this->data['checkout_images'] = $this->model_tool_image->resize($this->config->get('config_checkout_images'), 100, 100);		
		} else {
			$this->data['checkout_images'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
		
                 if (isset($this->request->post['config_mobile_checkout_images'])) {
			$this->data['mobile_checkout_images'] = $this->request->post['config_mobile_checkout_images'];
		} else {
			$this->data['config_mobile_checkout_images'] = $this->config->get('config_mobile_checkout_images');			
		     }
		if ($this->config->get('config_mobile_checkout_images') && file_exists(DIR_IMAGE . $this->config->get('config_mobile_checkout_images')) && is_file(DIR_IMAGE . $this->config->get('config_mobile_checkout_images'))) {
			$this->data['mobile_checkout_images'] = $this->model_tool_image->resize($this->config->get('config_mobile_checkout_images'), 100, 100);		
		} else {
			$this->data['mobile_checkout_images'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
		...
		if (isset($this->request->post['config_alert_emails'])) {
			...
			$this->data['config_alert_emails'] = $this->config->get('config_alert_emails');
                 ...
                 if (isset($this->request->post['config_mail_on_order_statuses_set_to_furniture_shipped'])) {
			$this->data['config_mail_on_order_statuses_set_to_furniture_shipped'] = $this->request->post['config_mail_on_order_statuses_set_to_furniture_shipped'];
		} else {
			$this->data['config_mail_on_order_statuses_set_to_furniture_shipped'] = $this->config->get('config_mail_on_order_statuses_set_to_furniture_shipped');
		}
                
                if (isset($this->request->post['config_emails_on_order_status_furniture_shipped'])) {
			$this->data['config_emails_on_order_status_furniture_shipped'] = $this->request->post['config_emails_on_order_status_furniture_shipped'];
		} else {
			$this->data['config_emails_on_order_status_furniture_shipped'] = $this->config->get('config_emails_on_order_status_furniture_shipped');
		}
