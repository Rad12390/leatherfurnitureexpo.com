...
class ControllerToolKaExport extends KaController {
    ...
    public function step2() { // step2
        ...
        $this->data['group_products'] = $sets['group_products'];
        $this->data['group_products_general'] = $sets['group_products_general'];
    ...
    public function step3() { // step3 
        ...
        $this->data['page_url'] = str_replace('&amp;', '&', $this->url->link('tool/ka_export/stat', 'format=raw&tmpl=component&token=' . $this->session->data['token'], 'SSL'));
        $this->template = 'tool/ka_export.tpl';
