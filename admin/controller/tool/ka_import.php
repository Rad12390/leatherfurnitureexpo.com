...
class ControllerToolKaImport extends KaController {
    ...
    private function updateMatches() {
        ...
        $sets = array(
            ...
            'grouped_products' => array('field'),
            'grouped_products_general' => array('field'),
    ...
    public function step2() { // step2 
        ...
        $this->data['grouped_products'] = $sets['grouped_products'];
        $this->data['grouped_products_general'] = $sets['grouped_products_general'];
		...
		if (empty($this->params['matches'])) {
            $matches = array(
                ...
                'grouped_products' => $this->data['grouped_products'],
                'grouped_products_general' => $this->data['grouped_products_general'],
...
//echo "<pre>"; print_r($this->params['matches']);
