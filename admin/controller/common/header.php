...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_attribute_production_time'] = $this->language->get('text_attribute_production_time');
...
//        $this->data['text_openbay_order_import'] = $this->language->get('text_openbay_order_import');
		...
		$this->data['text_swatch'] = $this->language->get('text_swatch');
				$this->data['text_callforprice'] = $this->language->get('text_callforprice');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['attribute_production_time'] = $this->url->link('catalog/attribute_production_time', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['report_product_purchased'] = $this->url->link('report/product_purchased', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['report_downloaded'] = $this->url->link('report/downloaded', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['report_swatch_system']=$this->url->link('report/swatch_system','token=' .$this->session->data['token'], 'SSL');			
$this->data['report_call_price']=$this->url->link('report/call_price','token=' .$this->session->data['token'], 'SSL');	
