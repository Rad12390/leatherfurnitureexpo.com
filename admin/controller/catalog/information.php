...
class ControllerCatalogInformation extends Controller { 
	...
	protected function getForm() {
		...
		if (isset($this->request->post['exclude_status'])) {
			$this->data['exclude_status'] = $this->request->post['exclude_status'];
		} elseif (!empty($information_info)) {
			$this->data['exclude_status'] = $information_info['exclude_status'];
		} else {
			$this->data['exclude_status'] = 0;
		}
