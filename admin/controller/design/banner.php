...
class ControllerDesignBanner extends Controller {
    ...
    protected function getForm() {
        ...
        $this->data['entry_image_phone'] = $this->language->get('entry_image_phone');	
        $this->data['entry_image_tablet'] = $this->language->get('entry_image_tablet');
        ...
        foreach ($banner_images as $banner_image) {
            ...
            if ($banner_image['image_tablet'] && file_exists(DIR_IMAGE . $banner_image['image_tablet'])) {
                $image_tablet = $banner_image['image_tablet'];
            } else {
                $image_tablet = 'no_image.jpg';
            }
            if ($banner_image['image_phone'] && file_exists(DIR_IMAGE . $banner_image['image_phone'])) {
                $image_phone = $banner_image['image_phone'];
            } else {
                $image_phone = 'no_image.jpg';
            }
            ...
            $this->data['banner_images'][] = array(
                ...
                'thumb_mobile' => $this->model_tool_image->resize($image_phone, 100, 100),
                'thumb_tablet' => $this->model_tool_image->resize($image_tablet, 100, 100),
