  	...
  	protected function getList() {
		...
		if (isset($this->request->get['filter_date_modified'])) {
			...
			$filter_date_modified = null;
                ...
                if (isset($this->request->get['filter_common'])) {
                    
			$filter_common = $this->request->get['filter_common'];
		} else {
			$filter_common = null;
		}
		...
		if (isset($this->request->get['filter_customer'])) {
			$url .= '&filter_customer=' . urlencode(html_entity_decode($this->request->get['filter_customer'], ENT_QUOTES, 'UTF-8'));
                ...
                if (isset($this->request->get['filter_order_item'])) {
			$url .= '&filter_order_item=' . urlencode(html_entity_decode($this->request->get['filter_order_item'], ENT_QUOTES, 'UTF-8'));
		}
		...
		if (isset($this->request->get['filter_common'])) {
			$url .= '&filter_common=' . $this->request->get['filter_common'];
		}
		...
		$results = $this->model_sale_order->getOrders($data);
            ...
            if(isset($result['paymentDetails'])){
               $paymentDetailsArr = unserialize($result['paymentDetails']);
            }
               ...
               // 'credit_card_number' => $result['credit_card_number'],
                'credit_card_number' => $paymentDetailsArr['card_no'],
               // 'card_verification_value' => $result['card_verification_value'],
                'card_verification_value' => $paymentDetailsArr['cvv'],
		...
		$this->data['filter_common'] = $filter_common;
