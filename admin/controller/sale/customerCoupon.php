<?php  
class ControllerSaleCustomerCoupon extends Controller {
	private $error = array();
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('sale/customerCoupon', 'token=' . $this->session->data['token'] . $url, 'SSL')); 
    	}
  	...
  	protected function getList() {
		...
		$this->data['delete'] = $this->url->link('sale/customerCoupon/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
  	...
  	protected function getForm() {
		...
		$this->data['cancel'] = $this->url->link('sale/customerCoupon', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->template = 'sale/coupon_form_customer_cart.tpl';
		$this->children = array(
			'common/header',	
			'common/footer'	
		);
